...
const Side_body = () => {
  ...
  const isMenuOpen = useSelector(store => store.sideBar.values);

  if (!isMenuOpen) return null;

  return (
    <div className='p-5 max-h-screen hover:overflow-y-scroll overflow-hidden overscroll-contain fixed top-[55px] bg-white text-left w-[200px]'>
      <ul>
